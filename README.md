...
<modules>
	<module version="0.1">it.smc.navitems</module>
</modules>
...
For example,
	...
	var my_module = require('it.smc.navitems');
	my_module.foo();
...
To create a module, create a file named it.smc.navitems.js under the assets folder.
